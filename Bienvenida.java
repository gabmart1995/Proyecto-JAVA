...
public class Bienvenida extends JFrame implements ActionListener {
	...
	public static String texto = ""; //variable de la clase
	...
	public Bienvenida() {
			...
			boton1.addActionListener(this);  //accion del boton
			add(boton1);
	...
	public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == boton1) {
					...
					//recupera el texto borra los espacios
					...
					if (texto.equals("")) {
							...
							//llama a la interfaz grafica de licencia
